# FurryOS Gen2.1 Builder (FurryOS_Gen2_Builder_GUI.py)

FurryOS Gen2.1 Builder is a toolchain for creating a customized Debian Live ISO themed for FurryOS (anthro-focused desktop experience). Drop in your own wallpapers, sounds, docs, and desktop scripts, then build a bootable ISO.
...
## FurryOS Gen2.1 Payload Assets (1.1GB):
